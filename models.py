...
class Business(Model):
    id = fields.IntField(pk=True, index=True)
    business_name = fields.CharField(max_length=50, null=False, unique=False)
    city = fields.CharField(max_length=100, null=False, default='Não Informado')
    region = fields.CharField(max_length=100, null=False, default='Não Informado')
...
class Product(Model):
    ...
    original_prace = fields.DecimalField(max_digits=12, decimal_places=2)
